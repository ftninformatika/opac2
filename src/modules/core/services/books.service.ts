...
export class BooksService {
  ...
  public search(
    searchRequest: IResultPageSearchRequest,
    pageNumber: number = 0,
    pageSize: number = 10
  ): Observable<IResultPage> {
    return this._httpClient.post(
      `${ApiEndpointConfig.Paths.search.main}?pageNumber=${pageNumber}&pageSize=${pageSize}`,
      searchRequest
    ) as Observable<IResultPage>;
  }
  ...
  public searchByIds(
    ...
    return this._httpClient.post(
      `${ApiEndpointConfig.Paths.search.byIds}?pageNumber=${pageNumber}&pageSize=${pageSize}`,
      searchRequest
    ) as Observable<IResultPage>;
  }
  ...
  public autocomplete(query: string): Observable<IPrefixValue[]> {
    return this._httpClient.post(
      ApiEndpointConfig.Paths.search.autocomplete,
      query
    ) as Observable<IPrefixValue[]>;
  }

  public getBook(_id: string): Observable<Book> {
    return this._httpClient.post(
      ApiEndpointConfig.Paths.book.main,
      _id
    ) as Observable<Book>;
  }
  ...
  public getMultipleBooks(recordsIds: string[]): Observable<Book[]> {
    return this._httpClient.post(
      ApiEndpointConfig.Paths.book.getMultiple,
      recordsIds
    ) as Observable<Book[]>;
  }
  ...
  public getBooksByCollId(collId: string): Observable<Book[]> {
    return this._httpClient.post(
      ApiEndpointConfig.Paths.book.getByCollectionId,
      collId
    ) as Observable<Book[]>;
  }

  public createModifyBookCommon(
    bookCommon: BookCommon
  ): Observable<BookCommon> {
    return this._httpClient.post(
      ApiEndpointConfig.Paths.bookCommon.main,
      bookCommon
    ) as Observable<BookCommon>;
  }
